...
<!-- This template used for admin panle page -->
<template>
<aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
    <div>
        ...
        <ul class="space-y-2 tracking-wide mt-8">
            <li>
                <Link href="/admin" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
            ...
            <li>
                <Link href="admin/roles" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
